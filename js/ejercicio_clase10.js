...
var listLocalDB = localStorage.getItem("listPersonalData");

function registerPerson() {
    let iDNI = document.getElementById("iDNI").value;
  ...
  // Verificar DNI unico
  /*
  if (verifyDNIUnique(iDNI) === false) {
    window.alert("DNI ya fue ingresado");
    return;
  }*/
  ...
  // Save on Local DB
  localStorage.setItem("listPersonalData", JSON.stringify(arrPersons));
...
//TODO COMPLETAR!!!
function verifyDNIUnique(iDNI) {
    var counts = listado.find((element) => element.dni === iDNI);
